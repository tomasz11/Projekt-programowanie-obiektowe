...
class Player:
    def __init__(self, x, y):
        # 1. Ładujemy obrazek PNG
        # .convert_alpha() jest kluczowe dla przezroczystości tła obrazka
        skins = ["ninja.png","john.png"]
        self.original_image = pygame.image.load(skins[1]).convert_alpha()
        
        # 2. Skalujemy go do rozmiaru 40x40 (takiego jak Twój grid)
        self.image = pygame.transform.scale(self.original_image, (50,80))
        
        # 3. Tworzymy rect na podstawie obrazka
